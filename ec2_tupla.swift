...
func calculeaza(_ coef:(a:Float, b:Float, c:Float),_ x1: inout (re:Float, im:Float), 
_ x2: inout (re:Float, im:Float))
{
...
func tipareste(_ x1: (re:Float, im:Float), 
_ x2:(re:Float, im:Float))
{
